...
public class Seba5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba5);
...
//        AdmobAds.sdkInitialize(Seba5Activity.this);
//        AdmobAds.setBanner(banner_ads,Seba5Activity.this);
//        //............banner add...........
        ...
        RequestQueue queue = Volley.newRequestQueue(Seba5Activity.this);
        String url = "https://manikganjcityapp.xyz/apps/fire_service.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    recyclerview.setLayoutManager(new LinearLayoutManager(Seba5Activity.this));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = layoutInflater.inflate(R.layout.fire_service_item, parent, false);
