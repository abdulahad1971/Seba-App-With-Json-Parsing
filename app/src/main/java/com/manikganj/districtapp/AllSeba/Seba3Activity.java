...
public class Seba3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba3);
...
//        AdmobAds.sdkInitialize(Seba3Activity.this);
//        AdmobAds.setBanner(banner_ads,Seba3Activity.this);
//        //............banner add...........
        ...
        RequestQueue queue = Volley.newRequestQueue(Seba3Activity.this);
        String url = "https://manikganjcityapp.xyz/apps/ambulance.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    recyclerview.setLayoutManager(new LinearLayoutManager(Seba3Activity.this));
