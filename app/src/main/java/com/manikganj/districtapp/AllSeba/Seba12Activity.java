...
public class Seba12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba12);
...
//        AdmobAds.sdkInitialize(Seba12Activity.this);
//        AdmobAds.setBanner(banner_ads,Seba12Activity.this);
//        //............banner add...........
        ...
        RequestQueue queue = Volley.newRequestQueue(Seba12Activity.this);
        String url = "https://manikganjcityapp.xyz/apps/sasto_complex.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("sasto_complex");
                    ...
                    recyclerview.setLayoutManager(new LinearLayoutManager(Seba12Activity.this));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = layoutInflater.inflate(R.layout.sasto_complex, parent, false);
