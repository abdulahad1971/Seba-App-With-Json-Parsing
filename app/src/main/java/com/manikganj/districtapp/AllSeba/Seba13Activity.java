...
public class Seba13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba13);
...
//        AdmobAds.sdkInitialize(Seba13Activity.this);
//        AdmobAds.setBanner(banner_ads,Seba13Activity.this);
//        //............banner add...........
        ...
        RequestQueue queue = Volley.newRequestQueue(Seba13Activity.this);
        String url = "https://manikganjcityapp.xyz/apps/polli_biddut.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("polli_biddut");
                   ...
                   MyAdapter myAdapter = new MyAdapter();
                    recyclerview.setLayoutManager(new LinearLayoutManager(Seba13Activity.this));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = layoutInflater.inflate(R.layout.polli_biddut, parent, false);
