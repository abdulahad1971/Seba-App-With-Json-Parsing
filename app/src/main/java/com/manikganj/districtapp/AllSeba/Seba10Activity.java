...
public class Seba10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba10);
...
//        AdmobAds.sdkInitialize(Seba10Activity.this);
//        AdmobAds.setBanner(banner_ads,Seba10Activity.this);
//        //............banner add...........
        ...
        RequestQueue queue = Volley.newRequestQueue(Seba10Activity.this);
        String url = "https://manikganjcityapp.xyz/apps/bmt_seba.json";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("bmt");
                    ...
                    recyclerview.setLayoutManager(new LinearLayoutManager(Seba10Activity.this));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = layoutInflater.inflate(R.layout.bmt_item,parent,false);
